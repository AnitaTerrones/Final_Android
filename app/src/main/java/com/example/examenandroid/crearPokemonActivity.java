...
public class crearPokemonActivity extends AppCompatActivity {
    ...
    ImageView imageView = findViewById(R.id.ivPokemon);
    EditText etImagen1 = findViewById(R.id.etImagePok);
    String base64;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText etNombre = findViewById(R.id.etNombrePok);
        EditText etTipo = findViewById(R.id.etTipoPok);
        EditText etLatitud = findViewById(R.id.etLatitud);
        EditText etLongitud = findViewById(R.id.etLongitud);
        Button btnSubirImagen = findViewById(R.id.btnSubirPok);
        Button btnCrearPoke = findViewById(R.id.btnCrearPokemon);
        ...
        btnCrearPoke.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Imagen = etImagen1.getText().toString();
                Number Latitude = etLatitud.getText().length();
                Number Longitud = etLongitud.getText().length();
